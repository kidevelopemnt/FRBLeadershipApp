...
* `frbleadershipapp` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `FRBLeadershipApp` - executable or bundle name on disk.
* `FRBLeadershipApp` - display name shown in window titles and about app dialogs.
